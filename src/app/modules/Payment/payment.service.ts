...
const initiatePayment = async (paymentData: any) => {
  ...
  try {
    const response = await axios.post(config.payment_url!, {
      ...
      success_url: `https://sports-facility-booking-platform.vercel.app/api/payment/confirmation?transactionId=${paymentData.bookingId}-${paymentData.transactionId}&status=success`,
      fail_url: `https://sports-facility-booking-platform.vercel.app/api/payment/confirmation?status=failed`,
